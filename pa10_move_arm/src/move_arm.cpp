...
// 			std::cout << std::endl;
	...
	// 		pub2.publish(pt);
			...
			target_pose_link.pose.position.x = -0.630;
			target_pose_link.pose.position.y = 0.136;
			target_pose_link.pose.position.z = 0.517;
			...
			group.setPoseTarget(target_pose_link.pose, "gripper");
